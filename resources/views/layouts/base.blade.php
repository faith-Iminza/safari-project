...
<body>
  ...
  <div id="topbar" class="d-flex align-items-center fixed-top">
    <div class="container d-flex justify-content-center justify-content-md-between">
      ...
      <div class="contact-info d-flex align-items-center">
        <i class="bi bi-phone d-flex align-items-center"><span>+254741621240</span></i>
  ...
  <header id="header" class="fixed-top d-flex align-items-cente">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
      ...
      <h1 class="logo me-auto me-lg-0"><a href="/">420 Safari</a></h1>
      ...
      <a href="#book-a-table" class="book-a-table-btn scrollto d-none d-lg-flex">Book a Safari</a>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container position-relative text-center text-lg-start" data-aos="zoom-in" data-aos-delay="100">
      <div class="row">
        <div class="col-lg-8">
          <h1>Welcome to <span>420 Safaris</span></h1>
          <h2>Experience the Luxurity Of Nature</h2>

          <div class="btns">
            <a href="#events" class="btn-menu animated fadeInUp scrollto">Packages</a>
            <a href="#book-a-table" class="btn-book animated fadeInUp scrollto">Book a Safari</a>
          </div>
        </div>
  ...
  <main id="main">
    ...
    <section id="events" class="events">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Packages</h2>
          <p>Relax and Enjoy luxurity of Nature on a budget</p>
        </div>
    ...
    <section id="book-a-table" class="book-a-table">
      <div class="container" data-aos="fade-up">
        ...
        <form action="{{ route('send.email') }}" method="POST" role="form"  data-aos="fade-up" data-aos-delay="100">
          <div class="row">
            @csrf
          ...
          <div class="text-center"><button type="submit">Book a Safari</button></div>
        </form>
    ...
    <section id="gallery" class="gallery">
      ...
      <div class="container" data-aos="fade-up">
        <div class="section-title">
          <h2>Gallery</h2>
          <p>Some photos from the Safaris</p>
        </div>
      </div>
          ...
          <div class="col-lg-4">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p>Kijabe Street,Nairobi,Kenya</p>
              </div>
